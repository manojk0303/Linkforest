      ...
      <main className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 md:mb-16 space-y-4">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-balance">Simple, Free for Everyone</h1>
            <p className="text-lg md:text-xl text-muted-foreground text-balance">
              All features are now completely free. No credit card required.
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <Card className="relative border-2 border-primary shadow-xl hover:shadow-2xl transition-shadow max-w-md w-full">
              ...
              <CardHeader>
                <CardTitle className="text-2xl">{freeTier.displayName}</CardTitle>
                <CardDescription>All premium features at no cost</CardDescription>
                <div className="mt-4">
                  <span className="text-4xl font-bold">{freeTier.price}</span>
                  <span className="text-muted-foreground ml-2">{freeTier.priceDetail}</span>
                </div>
              </CardHeader>
            ...
            <div className="grid sm:grid-cols-2 gap-6 md:gap-8 text-left max-w-4xl mx-auto">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Yes! All features are completely free with no hidden costs or time limits.
                </p>
              </div>
              <div className="space-y-2">
                <h4 className="font-semibold">Will it always be free?</h4>
                <p className="text-sm text-muted-foreground">
                  Currently all features are free. We may introduce premium tiers in the future, but existing users will
                  keep their access.
                </p>
              </div>
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Point your domain's DNS to LinkForest, and we'll verify it automatically. Takes 5-10 minutes to set
                  up.
                </p>
              </div>
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  All users get access to our support system. We're here to help you succeed!
                </p>
              </div>
            </div>
          </div>
